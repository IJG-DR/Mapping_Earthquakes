...
d3.json(earthquakeData).then(function(data) {
    ...
    function styleInfo(feature) {
        ...
        opacity: 1,
        fillOpacity: 1,
        // call the function to get the color based on magnitude
    ...
    // Create a function to determine the color of the circle based on 
    ...
    L.geoJson(data, {
        ...
        pointToLayer: function(feature, latlng) {
                    ...
                    // Set the style of each circleMarker using styleInfo function.
                    style: styleInfo,
